      ...
      <div className='pizza__block'>
        ...
        <div className='pizza__description'>
          ...
          <p className='pizza__text'>
            ...
            error distinctio ea fugiat vitae perferendis, earum voluptatum ipsa
            maiores esse obcaecati iure consectetur nisi impedit nobis,
            assumenda tempora tempore laudantium odit ab necessitatibus sequi
            debitis commodi. Numquam praesentium dignissimos beatae?
          </p>
